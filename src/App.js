        ...
        <div className="landing-two-col" translate="no">
          <div className="landing-left-text" style={{ marginTop: '2.5rem' }} translate="no">
            ...
            <div className="button-group-theme" style={{ justifyContent: 'flex-start' }}>
              ...
              <a href="https://www.linkedin.com/in/atishay-kasliwal/" target="_blank" rel="noopener noreferrer" className="btn-theme btn-secondary btn-lg" aria-label="LinkedIn">
                <span style={{ display: 'flex', alignItems: 'center', gap: '0.75em' }}>
              ...
              <a href="https://github.com/atishay-kasliwal" target="_blank" rel="noopener noreferrer" className="btn-theme btn-secondary btn-lg" aria-label="GitHub">
                <span style={{ display: 'flex', alignItems: 'center', gap: '0.75em' }}>
