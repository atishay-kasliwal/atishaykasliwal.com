...
export const projectsData = [
  ...
  },
  {
    ...
    description: 'Ten classical encryption algorithms — Affine to XOR — built in C++17 with full encrypt/decrypt, validated input, and GitHub Actions CI.',
    seoTitle: 'Classical Cipher Toolkit — 10 Encryption Algorithms in C++17',
    seoDescription: 'A production-ready C++17 console application implementing Affine, Vigenère, Rail-Fence, Route, XOR, Morse, Polybius Square, Atbash, Baconian, and Simple Substitution ciphers — each with full encryption and decryption, zero warnings under -Wall -Wextra, and CI via GitHub Actions on Ubuntu and macOS.',
    image: 'https://images.unsplash.com/photo-1526374965328-7f61d4dc18c5?q=80&w=800&h=500&auto=format&fit=crop',
    link: '/highlights/c7d8e9f0-a1b2-4345-c678-9abcdef01234',
